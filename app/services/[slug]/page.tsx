                ...
                {detailContent.features.map((feature, index) => (
                  <AnimatedSection key={index} animation="fade-up" delay={index * 100}>
                    <TiltCard maxTilt={5} className="h-full">
                      <div className="bg-white rounded-2xl p-6 md:p-8 h-full shadow-lg hover:shadow-xl transition-shadow border border-[#e5e7eb]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                {detailContent.benefits.map((benefit, index) => (
                  <AnimatedSection key={index} animation="fade-up" delay={index * 50}>
                    <div className="flex items-start gap-4 p-4 md:p-6 bg-[#fafafa] rounded-xl border border-[#e5e7eb]">
                ...
                {otherServices.map((s, index) => (
                  <AnimatedSection key={s.slug} animation="fade-up" delay={index * 100}>
                    <Link 
                      ...
                      className="block bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all hover:-translate-y-1 border border-[#e5e7eb]"
                    >
